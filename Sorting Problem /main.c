...
//-----------------------------------------------------------------------------------------
    ...
    if (strcmp(ans, "y") == 0 || strcmp(ans, "Y") == 0){
      removefile("C/SelectionSort_C_10.txt");
      removefile("C/SelectionSort_C_100.txt");
      removefile("C/SelectionSort_C_1000.txt");
      removefile("C/SelectionSort_C_10000.txt");
      removefile("C/SelectionSort_C_100000.txt");
      removefile("C/InsertionSort_C_10.txt");
      removefile("C/InsertionSort_C_100.txt");
      removefile("C/InsertionSort_C_1000.txt");
      removefile("C/InsertionSort_C_10000.txt");
      removefile("C/InsertionSort_C_100000.txt");
      removefile("C/MergeSort_C_10.txt");
      removefile("C/MergeSort_C_100.txt");
      removefile("C/MergeSort_C_1000.txt");
      removefile("C/MergeSort_C_10000.txt");
      removefile("C/MergeSort_C_100000.txt");
