...
t0 = dt.datetime.now()
merge_sort(list1)
merge_time1 = (dt.datetime.now()-t0).microseconds
...
t0 = dt.datetime.now()
merge_sort(list3)
merge_time3 = (dt.datetime.now()-t0).microseconds

t0 = dt.datetime.now()
merge_sort(list4)
merge_time4 = (dt.datetime.now()-t0).microseconds
...
t0 = dt.datetime.now()
selectionSort(list6)
select_time1 = (dt.datetime.now()-t0).microseconds

t0 = dt.datetime.now()
selectionSort(list7)
select_time2 = (dt.datetime.now()-t0).microseconds

t0 = dt.datetime.now()
selectionSort(list8)
select_time3 = (dt.datetime.now()-t0).microseconds

t0 = dt.datetime.now()
selectionSort(list9)
select_time4 = (dt.datetime.now()-t0).microseconds

t0 = dt.datetime.now()
selectionSort(list10)
select_time5 = (dt.datetime.now()-t0).microseconds
...
insert_time1 = (dt.datetime.now()-t0).microseconds


t0 = dt.datetime.now()
insertionSort(list12)
insert_time2 = (dt.datetime.now()-t0).microseconds


t0 = dt.datetime.now()
insertionSort(list13)
insert_time3 = (dt.datetime.now()-t0).microseconds


t0 = dt.datetime.now()
insertionSort(list14)
insert_time4 = (dt.datetime.now()-t0).microseconds


t0 = dt.datetime.now()
insertionSort(list15)
insert_time5 = (dt.datetime.now()-t0).microseconds
